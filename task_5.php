...
$items = [
    [
        ...
        "imgmin" => "img/demo/gallery/thumb/21.jpg"
    ],
    [
        "img" => "img/demo/gallery/22.jpg",
        "imgmin" => "img/demo/gallery/thumb/22.jpg"
    ],
    [
        "img" => "img/demo/gallery/23.jpg",
        "imgmin" => "img/demo/gallery/thumb/23.jpg"
    ],
    [
        "img" => "img/demo/gallery/24.jpg",
        "imgmin" => "img/demo/gallery/thumb/24.jpg"
    ],
    [
        "img" => "img/demo/gallery/25.jpg",
        "imgmin" => "img/demo/gallery/thumb/25.jpg"
    ],
    [
        "img" => "img/demo/gallery/26.jpg",
        "imgmin" => "img/demo/gallery/thumb/26.jpg"
    ],
];
                    ?>
                        ...
                        <div class="panel-content">
                            ...
                            <div id="js-lightgallery">
                                ...
                                <a class="" href="<?php echo $item['img'];?>">
                                    <img class="img-responsive" src="<?php echo $item['imgmin'];?>" alt="image">
                                </a>
                                <?php endforeach;?>
                                <!--
