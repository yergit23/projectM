...
*/
                    ...
                    <div class="panel-container show">
                        ...
                        <?php foreach ($peoples as $people):?>
                            <div class="<?php echo $people['status'] =='banned' ? 'banned' : ''?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?php echo $people['img'];?>" alt="<?php echo $people['imgalt'];?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    ...
                                    <a href="<?php echo $people['url'];?>" class="text-info fs-sm" target="_blank"><?php echo $people['urltitle'];?></a> -
                                    <a href="<?php echo $people['email'];?>" class="text-info fs-sm" target="_blank" title="<?php echo $people['emailtitle'];?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
                        <?php endforeach;?>
                        <!--
